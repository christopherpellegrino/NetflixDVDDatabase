...
REM Member, Payment, Rental, RentalQueue
declare AddMonths int := 12 * (extract(year from current_date) - 2005);
begin
INSERT INTO Member(MemberId,MemberFirstName,MemberLastName,MemberAddress,
	...
	1,Add_Months(to_date('02/01/2004','MM/DD/YYYY'), AddMonths));
INSERT INTO Member(MemberId,MemberFirstName,MemberLastName,MemberAddress,
	MemberAddressId,MemberEMail,MemberPassword,MembershipId,MemberSinceDate)
	VALUES (2,'John','Gore','45 5th Ave',2,'john45@yahoo.com','J0HnGoRe',
	1,Add_Months(to_date('02/02/2004','MM/DD/YYYY'), AddMonths));
INSERT INTO Member(MemberId,MemberFirstName,MemberLastName,MemberAddress,
	MemberAddressId,MemberEMail,MemberPassword,MembershipId,MemberSinceDate)
	VALUES (3,'Mike','Sawicki','10 Penn Blvd',3,'mikesawicki@aol.com','Saw13ki',2,Add_Months(to_date('02/09/2004','MM/DD/YYYY'), AddMonths));
INSERT INTO Member(MemberId,MemberFirstName,MemberLastName,MemberAddress,
	MemberAddressId,MemberEMail,MemberPassword,MembershipId,MemberSinceDate)
	VALUES (4,'Ramesh','Mandadi','9 Avelon Apt',4,'ramesh1@yahoo.com','Ram3sh',1,Add_Months(to_date('02/11/2004','MM/DD/YYYY'), AddMonths));
INSERT INTO Member(MemberId,MemberFirstName,MemberLastName,MemberAddress,
	MemberAddressId,MemberEMail,MemberPassword,MembershipId,MemberSinceDate)
	VALUES (5,'Frank','Cruthers','1129 Jackson Rd',5,'franky@aol.com','qW1est',2,Add_Months(to_date('02/12/2004','MM/DD/YYYY'), AddMonths));
INSERT INTO Member(MemberId,MemberFirstName,MemberLastName,MemberAddress,
	MemberAddressId,MemberEMail,MemberPassword,MembershipId,MemberSinceDate)
	VALUES (6,'Rich','Sentveld','1001 Plainsboro Rd',6,'richard@aol.com','R1chArd',1,Add_Months(to_date('02/12/2004','MM/DD/YYYY'), AddMonths));
INSERT INTO Member(MemberId,MemberFirstName,MemberLastName,MemberAddress,
	MemberAddressId,MemberEMail,MemberPassword,MembershipId,MemberSinceDate)
	VALUES (7,'George','Lemon','29456 Upper Ferry Rd',7,'glemon@aol.com','ImG3m0n',2,Add_Months(to_date('02/14/2004','MM/DD/YYYY'), AddMonths));
INSERT INTO Member(MemberId,MemberFirstName,MemberLastName,MemberAddress,
	MemberAddressId,MemberEMail,MemberPassword,MembershipId,MemberSinceDate)
	VALUES (8,'Haby','Tanjung','5 River Rd',8,'ht@hasby.com','T1c00l',1,Add_Months(to_date('02/15/2004','MM/DD/YYYY'), AddMonths));
INSERT INTO Member(MemberId,MemberFirstName,MemberLastName,MemberAddress,
	MemberAddressId,MemberEMail,MemberPassword,MembershipId,MemberSinceDate)
	VALUES (9,'Cathy','Carol','59 Eaton Twon',9,'carol@hotmail.com','C9thC3ty',2,Add_Months(to_date('02/15/2004','MM/DD/YYYY'), AddMonths));
INSERT INTO Member(MemberId,MemberFirstName,MemberLastName,MemberAddress,
	MemberAddressId,MemberEMail,MemberPassword,MembershipId,MemberSinceDate)
	VALUES (10,'Marji','Keho','2365 Merci Blvd',10,'marji.keho@merci.com','M1rjii',1,Add_Months(to_date('02/19/2004','MM/DD/YYYY'), AddMonths));
INSERT INTO Member(MemberId,MemberFirstName,MemberLastName,MemberAddress,
	MemberAddressId,MemberEMail,MemberPassword,MembershipId,MemberSinceDate)
	VALUES (11,'Clint','Eastwood','90 Hill Rd',11,'eastwoodc@gmail.com','Clint12',1,Add_Months(to_date('02/19/2004','MM/DD/YYYY'), AddMonths));
INSERT INTO Member(MemberId,MemberFirstName,MemberLastName,MemberAddress,
	MemberAddressId,MemberEMail,MemberPassword,MembershipId,MemberSinceDate)
     VALUES (12,'Bruce','Willis','1740 Erford Rd',12,'brucewillis@aol.com','YgDm3n',1,Add_Months(to_date('02/21/2004','MM/DD/YYYY'), AddMonths));
INSERT INTO Member(MemberId,MemberFirstName,MemberLastName,MemberAddress,
	MemberAddressId,MemberEMail,MemberPassword,MembershipId,MemberSinceDate)
	VALUES (13,'Yong','Lee','1 Yong-Yong Park',13,'yonglee@lee1.com','Y0ngY0ng',1,Add_Months(to_date('02/28/2004','MM/DD/YYYY'), AddMonths));
INSERT INTO Member(MemberId,MemberFirstName,MemberLastName,MemberAddress,
	MemberAddressId,MemberEMail,MemberPassword,MembershipId,MemberSinceDate)
     VALUES (14,'Jerald','Parekh','3434 Campus Rd',14,'jer9439@hotmail.com','C0sm0s',2,Add_Months(to_date('02/29/2004','MM/DD/YYYY'), AddMonths));
INSERT INTO Member(MemberId,MemberFirstName,MemberLastName,MemberAddress,
	MemberAddressId,MemberEMail,MemberPassword,MembershipId,MemberSinceDate)
   VALUES (15,'Kristy','Hanifin','67 Jackob Creek Rd',15,'kristine@aol.com','ImKr1sty',1,Add_Months(to_date('02/29/2004','MM/DD/YYYY'), AddMonths));

INSERT INTO Payment(PaymentId,MemberId,AmountPaid,AmountPaidDate,AmountPaidUntilDate)
	VALUES (1,1,19.78,Add_Months(to_date('02/01/2004','MM/DD/YYYY'), AddMonths),Add_Months(to_date('03/01/2004','MM/DD/YYYY'), AddMonths));
INSERT INTO Payment(PaymentId,MemberId,AmountPaid,AmountPaidDate,AmountPaidUntilDate)
	VALUES (2,2,19.78,Add_Months(to_date('02/02/2004','MM/DD/YYYY'), AddMonths), Add_Months(to_date('03/02/2004','MM/DD/YYYY'), AddMonths));
INSERT INTO Payment(PaymentId,MemberId,AmountPaid,AmountPaidDate,AmountPaidUntilDate)
	VALUES (3,3,13.18,Add_Months(to_date('02/09/2004','MM/DD/YYYY'), AddMonths), Add_Months(to_date('03/09/2004','MM/DD/YYYY'), AddMonths));
INSERT INTO Payment(PaymentId,MemberId,AmountPaid,AmountPaidDate,AmountPaidUntilDate)
	VALUES (4,4,19.98,Add_Months(to_date('02/11/2004','MM/DD/YYYY'), AddMonths), Add_Months(to_date('03/11/2004','MM/DD/YYYY'), AddMonths));
INSERT INTO Payment(PaymentId,MemberId,AmountPaid,AmountPaidDate,AmountPaidUntilDate)
	VALUES (5,5,13.18,Add_Months(to_date('02/12/2004','MM/DD/YYYY'), AddMonths), Add_Months(to_date('03/12/2004','MM/DD/YYYY'), AddMonths));
INSERT INTO Payment(PaymentId,MemberId,AmountPaid,AmountPaidDate,AmountPaidUntilDate)
	VALUES (6,6,19.78,Add_Months(to_date('02/12/2004','MM/DD/YYYY'), AddMonths), Add_Months(to_date('03/12/2004','MM/DD/YYYY'), AddMonths));
INSERT INTO Payment(PaymentId,MemberId,AmountPaid,AmountPaidDate,AmountPaidUntilDate)
	VALUES (7,7,13.18,Add_Months(to_date('02/14/2004','MM/DD/YYYY'), AddMonths), Add_Months(to_date('03/14/2004','MM/DD/YYYY'), AddMonths));
INSERT INTO Payment(PaymentId,MemberId,AmountPaid,AmountPaidDate,AmountPaidUntilDate)
	VALUES (8,8,19.78,Add_Months(to_date('02/15/2004','MM/DD/YYYY'), AddMonths), Add_Months(to_date('03/15/2004','MM/DD/YYYY'), AddMonths));
INSERT INTO Payment(PaymentId,MemberId,AmountPaid,AmountPaidDate,AmountPaidUntilDate)
	VALUES (9,9,13.18,Add_Months(to_date('02/15/2004','MM/DD/YYYY'), AddMonths), Add_Months(to_date('03/15/2004','MM/DD/YYYY'), AddMonths));
INSERT INTO Payment(PaymentId,MemberId,AmountPaid,AmountPaidDate,AmountPaidUntilDate)
	VALUES (10,10,19.78,Add_Months(to_date('02/19/2004','MM/DD/YYYY'), AddMonths), Add_Months(to_date('03/19/2004','MM/DD/YYYY'), AddMonths));
INSERT INTO Payment(PaymentId,MemberId,AmountPaid,AmountPaidDate,AmountPaidUntilDate)
	VALUES (11,11,19.78,Add_Months(to_date('02/19/2004','MM/DD/YYYY'), AddMonths), Add_Months(to_date('03/19/2004','MM/DD/YYYY'), AddMonths));
INSERT INTO Payment(PaymentId,MemberId,AmountPaid,AmountPaidDate,AmountPaidUntilDate)
	VALUES (12,12,19.98,Add_Months(to_date('02/21/2004','MM/DD/YYYY'), AddMonths), Add_Months(to_date('03/21/2004','MM/DD/YYYY'), AddMonths));
INSERT INTO Payment(PaymentId,MemberId,AmountPaid,AmountPaidDate,AmountPaidUntilDate)
	VALUES (13,1,25.00,Add_Months(to_date('02/21/2004','MM/DD/YYYY'), AddMonths), Add_Months(to_date('03/01/2004','MM/DD/YYYY'), AddMonths));
INSERT INTO Payment(PaymentId,MemberId,AmountPaid,AmountPaidDate,AmountPaidUntilDate)
	VALUES (14,13,19.78,Add_Months(to_date('02/28/2004','MM/DD/YYYY'), AddMonths), Add_Months(to_date('03/28/2004','MM/DD/YYYY'), AddMonths));
INSERT INTO Payment(PaymentId,MemberId,AmountPaid,AmountPaidDate,AmountPaidUntilDate)
	VALUES (15,14,13.18,Add_Months(to_date('02/29/2004','MM/DD/YYYY'), AddMonths), Add_Months(to_date('03/29/2004','MM/DD/YYYY'), AddMonths));
INSERT INTO Payment(PaymentId,MemberId,AmountPaid,AmountPaidDate,AmountPaidUntilDate)
	VALUES (16,15,19.78,Add_Months(to_date('02/29/2004','MM/DD/YYYY'), AddMonths), Add_Months(to_date('03/29/2004','MM/DD/YYYY'), AddMonths));

INSERT INTO Rental(RentalId,MemberId,DVDId,RentalRequestDate,
	RentalShippedDate,RentalReturnedDate)
 VALUES (1,1,4,Add_Months(to_date('02/02/2004','MM/DD/YYYY'), AddMonths),
	Add_Months(to_date('02/02/2004','MM/DD/YYYY'), AddMonths),Add_Months(to_date('02/09/2004','MM/DD/YYYY'), AddMonths));
INSERT INTO Rental(RentalId,MemberId,DVDId,RentalRequestDate,
	RentalShippedDate,RentalReturnedDate)
 VALUES (2,1,6,Add_Months(to_date('02/02/2004','MM/DD/YYYY'), AddMonths),Add_Months(to_date('02/02/2004','MM/DD/YYYY'), AddMonths),Add_Months(to_date('02/09/2004','MM/DD/YYYY'), AddMonths));
INSERT INTO Rental(RentalId,MemberId,DVDId,RentalRequestDate,RentalShippedDate,RentalReturnedDate)
 VALUES (3,1,3,Add_Months(to_date('02/02/2004','MM/DD/YYYY'), AddMonths),Add_Months(to_date('02/02/2004','MM/DD/YYYY'), AddMonths),Add_Months(to_date('02/09/2004','MM/DD/YYYY'), AddMonths));
INSERT INTO Rental(RentalId,MemberId,DVDId,RentalRequestDate,RentalShippedDate)
 VALUES (4,5,4,Add_Months(to_date('02/15/2004','MM/DD/YYYY'), AddMonths),Add_Months(to_date('02/15/2004','MM/DD/YYYY'), AddMonths));
INSERT INTO Rental(RentalId,MemberId,DVDId,RentalRequestDate,RentalShippedDate)
 VALUES (5,5,5,Add_Months(to_date('02/15/2004','MM/DD/YYYY'), AddMonths),Add_Months(to_date('02/15/2004','MM/DD/YYYY'), AddMonths));
INSERT INTO Rental(RentalId,MemberId,DVDId,RentalRequestDate,RentalShippedDate,RentalReturnedDate)
 VALUES (6,15,1,Add_Months(to_date('02/12/2004','MM/DD/YYYY'), AddMonths),Add_Months(to_date('02/12/2004','MM/DD/YYYY'), AddMonths),Add_Months(to_date('02/21/2004','MM/DD/YYYY'), AddMonths));
INSERT INTO Rental(RentalId,MemberId,DVDId,RentalRequestDate,RentalShippedDate)
 VALUES (7,9,2,Add_Months(to_date('02/19/2004','MM/DD/YYYY'), AddMonths),Add_Months(to_date('02/19/2004','MM/DD/YYYY'), AddMonths));
INSERT INTO Rental(RentalId,MemberId,DVDId,RentalRequestDate,RentalShippedDate)
 VALUES (8,8,2,Add_Months(to_date('02/20/2004','MM/DD/YYYY'), AddMonths),Add_Months(to_date('02/21/2004','MM/DD/YYYY'), AddMonths));
INSERT INTO Rental(RentalId,MemberId,DVDId,RentalRequestDate,RentalShippedDate)
 VALUES (9,1,4,Add_Months(to_date('02/20/2004','MM/DD/YYYY'), AddMonths),Add_Months(to_date('02/20/2004','MM/DD/YYYY'), AddMonths));
INSERT INTO Rental(RentalId,MemberId,DVDId,RentalRequestDate)
 VALUES (10,15,7,Add_Months(to_date('02/29/2004','MM/DD/YYYY'), AddMonths));
 
INSERT INTO RentalQueue(MemberId,DVDId,DateAddedInQueue)
 VALUES (12,5,Add_Months(to_date('02/22/2004','MM/DD/YYYY'), AddMonths));
end;
